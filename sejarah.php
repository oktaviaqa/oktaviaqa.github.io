...
$sejarah = query("SELECT * FROM db_sejarah");;
...
<body>
	...
	<!-- END nav -->
	<div class="hero-wrap" style="background-image: url('images/sejarah/bg-sejarah.jpg');height: 50vh;">
		<div class="overlay">
    </div>
		<div class="container-fluid">
		<div class="row justify-content-start mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate">
            <h2 class="mb-4" style="padding-top: 10rem; padding-left: 15rem; color:aliceblue""><strong>Wisata</strong> Sejarah</h2>
          </div>
        </div>
    		<div class="row">
